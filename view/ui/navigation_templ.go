...
func Navigation(create bool) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"navbar h-20 bg-base-content\"><div class=\"flex-none\"><i class=\"fa-solid fa-bars fa-xl ml-8\" style=\"color: #ffffff;\"></i></div><div class=\"flex-1\"><a class=\"btn btn-ghost text-white text-xl\">Sol'n Teacher Portal</a></div><div class=\"flex-none\">")
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"dropdown dropdown-end\"><div tabindex=\"0\" role=\"button\" class=\"btn btn-ghost btn-circle avatar mr-[20px]\"><div class=\"w-10 rounded-full\"><img alt=\"Tailwind CSS Navbar component\" src=\"http://localhost:3000/public/images/bg/sample_user.png\"></div></div><ul tabindex=\"0\" class=\"menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow\"><li><a class=\"justify-between\">Profile</a></li><li><a>Settings</a></li><li>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
